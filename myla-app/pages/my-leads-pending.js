...
export default function MyLeadsPending(){
  ...
  <div className="section-15 wf-section">
    <div className="text-block-25">
      ...
      we have sent the intake to but they have not replied. In three days, if
      the intake is not filled out, the client will move to the
      ACTION&nbsp;REQUIRED&nbsp;area of leads.
      <br />
      <br />
      <br />
      ...
      <br />
      <br />
      Date of initial contact | Name of Lead |&nbsp;Category | Status | Deadline
      | Last Contacted by | Last Contacted on | Notes /// edit leads button ///
      send lead to action required button
      <br />
      <br />
      The first three will be immediately filled in from the create client form.
      (Category corresponds to area of law on the form). Status will
      automatically be "pending intake". There will be dropdown options for
      status (pending intake, follow up required {"{"}if this is selected
      immediately move lead to action required{"}"} lost {"{"}move to historic
      {"}"} bounced {"{"}move to historic{"}"} retained {"{"}move to historic
      AND&nbsp;to my clients{"}"}).
      <br />
      <br />
      the name of the lead will be a hyperlink to the "leads area" for that
      lead. <a href="index">See this page</a>
      <br />
      <br />
      Last contacted by and last contacted on we'll leave blank for now as I
      haven't decided how/when it will be filled (I might add this to the create
      client form). Notes will be an editable area in the table where you can
      write anything
      <br />‍
    </div>
  </div>
