...
export default function MyLeadsPending() {
  return (
    <>
      <Head>
        <meta charset="utf-8" />
        <title>My Leads Pending</title>
      ...
      <>
        ...
        >
          <div className="container-3 w-container">
            ...
            <h2 className="heading-3">my leads</h2>
              ...
              >
                ...
                <nav className="dropdown-list-4 w-dropdown-list">
                  <a
                    ...
                    aria-current="page"
                    className="dropdown-link-7 w-dropdown-link w--current"
                  >
                    Pending Leads
                  </a>
                  <a
        ...
        <div className="div-block-13">
          ...
          <h4 className="heading-24">my leads - pending</h4>
        </div>
        <div className="section-15 wf-section">
          <div className="text-block-25">
            This Div block will contain a table which contains the list of
            clients who we have sent the intake to but they have not replied. In
            three days, if the intake is not filled out, the client will move to
            the ACTION&nbsp;REQUIRED&nbsp;area of leads.
            <br />
            <br />
            <br />
            ...
            <br />
            <br />
            Date of initial contact | Name of Lead |&nbsp;Category | Status |
            Deadline | Last Contacted by | Last Contacted on | Notes /// edit
            leads button /// send lead to action required button
            <br />
            <br />
            The first three will be immediately filled in from the create client
            form. (Category corresponds to area of law on the form). Status will
            automatically be "pending intake". There will be dropdown options
            for status (pending intake, follow up required {"{"}if this is
            selected immediately move lead to action required{"}"} lost {"{"}
            move to historic
            {"}"} bounced {"{"}move to historic{"}"} retained {"{"}move to
            historic AND&nbsp;to my clients{"}"}).
            <br />
            <br />
            the name of the lead will be a hyperlink to the "leads area" for
            that lead. <a href="index">See this page</a>
            <br />
            <br />
            Last contacted by and last contacted on we'll leave blank for now as
            I haven't decided how/when it will be filled (I might add this to
            the create client form). Notes will be an editable area in the table
