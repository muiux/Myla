...
export default function MyLeadsHistoric() {
  return (
    <>
      <Head>
        <meta charset="utf-8" />
        <title>My Leads Historic</title>
      ...
      <>
        ...
        <div className="div-block-13">
          ...
          <h4 className="heading-24">my leads - historic</h4>
        </div>
        <div className="section-15 wf-section">
          <div className="text-block-25">
            ...
            clients who we have completed the leads stage and now they are
            either lost, <br />
            bounced, or retained. A lead gets put in this table only if their
            status in My leads - pending was marked as lost, bounced, or
            retained on the <br />
            status column.
            <br />
            <br />
            ...
            <br />
            <br />
            you will be able to change the status or send the historic lead to
            action required, for example in the case the lead contacts you back
