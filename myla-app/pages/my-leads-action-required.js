...
export default function MyLeadsActionReuired() {
  return (
    <>
      <Head>
        <meta charset="utf-8" />
        <title>My Leads Action Required</title>
      ...
      <>
        ...
        <div className="div-block-13">
          ...
          <h4 className="heading-24">my leads - action required</h4>
        </div>
        <div className="section-15 wf-section">
          <div className="text-block-26">
            ...
            3 days. <br />
            <br />
            essentially the area where the legal assistant can go to immediately
            to see who she needs to follow up with. There will also be a<br /> "
            send follow up email"&nbsp;button right next to the lead, which will
            automate a follow up email using the client email address on record.{" "}
            <br />
            <br />
            <br />
            ...
            lead button // Send follow up email button
            <br />
            <br />
            The first three and deadline will be moved over from (Category
            corresponds to area of law on the form). Status will automatically
            be "follow up required". Last contacted by and &nbsp;Notes will be
            an editable area in the table where you can write anything
            <br />‍
          </div>
        </div>
        <div className="section-16 wf-section">
          <div className="field-label">Follow-Up Email Preview</div>
          <div>
            Here we will have the preview of the automated follow up email, with
            the option to attach a different default follow up email.
          </div>
        </div>
      </>
    </>
