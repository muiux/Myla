      ...
      <>
        ...
        <div className="section-15 wf-section">
          <div className="text-block-25">
            ...
            clients who have been retained (ie they've paid us and the lawyer is
            working on <br />
            their case). They will be moved here once you click on assign lawyer
            in the leads area. <br />
            <br />
            ...
            <br />
            <br />
            the name of the client in the table will be a hyperlink to the "my
            client area" for that client.{" "}
            <a href="client-area">See this page</a>
            <br />
            <br />
            <br />‍
          </div>
