                  ...
                  <nav className="dropdown-list w-dropdown-list">
                    <div className="leads-area-form w-form">
                      ...
                      >
                        ...
                        <div>
                          This is where we would be able connect the templated
                          email to the intake form
                        </div>
                        <label htmlFor="field" className="field-label-8">
                          Lawyer's Notes
                        </label>
                        <div>
                          This is where we would be able connect and select
                          which slack channel this intake form would send the
                          lawyer's notes to.
                        </div>
                        <label htmlFor="field" className="field-label-8">
                          Docusign
