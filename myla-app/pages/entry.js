      ...
      <>
          ...
          >
            <div className="container-8">
              <div className="navbar-wrapper-2">
                ...
                <nav
                  role="navigation"
                  className="nav-menu-wrapper-2 w-nav-menu"
                >
        ...
        <div className="section-4 wf-section">
          ...
          <div className="text-block-19">
            A legal assistant you can rely on.
          </div>
          <img
            ...
            <div className="hero-wrapper-2">
              <div className="hero-split-2">
                ...
                <p className="margin-bottom-24px-3">
                  ...
                  administration. Start your free 30-day trial with Myla today
                  to deliver your clients high quality solutions quickly.
                </p>
                  ...
                  <div className="testimonial-slide">
                    <div className="testimonial-content">
                      ...
                      <div className="testimonial-quote">
                        Myla has been essential to successfully handling my
                        clients.
                      </div>
